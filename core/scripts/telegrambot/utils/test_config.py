...
from utils.trial_state import (
    _creation_claim_is_active as _shared_creation_claim_is_active,
    _has_used_test_config_from as _shared_has_used_test_config_from,
    _mark_test_config_used_in_memory as _shared_mark_test_config_used_in_memory,
)
...
def _creation_claim_is_active(entry, now=None):
    return _shared_creation_claim_is_active(entry=entry, now=now)


def _has_used_test_config_from(configs, user_id, now=None):
    return _shared_has_used_test_config_from(configs=configs, user_id=user_id, now=now)
...
def _mark_test_config_used_in_memory(configs, user_id, username=None, language=None, telegram_username=None, server_id=None, used_at=None):
    return _shared_mark_test_config_used_in_memory(configs=configs, user_id=user_id, username=username, language=language, telegram_username=telegram_username, server_id=server_id, used_at=used_at)
